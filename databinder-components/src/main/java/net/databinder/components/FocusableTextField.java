...
/**
 * TextField that can be told to focus itself on the next request. Works in
 * conjunction with the onload handler.
 */
public class FocusableTextField<T> extends TextField<T> {
	...
	public FocusableTextField(final String id, final IModel<T> model) {
		super(id, model);
		// TODO add(ScriptLink.headerContributor(FocusableTextField.class));
	}
