...
public class JPAObjectModel<T> extends LoadableWritableModel<T> implements BindingModel<T> {
   ...
   */
  public JPAObjectModel(final Class<T> objectClass, final CriteriaBuilder criteriaBuilder) {
    this.objectClass = objectClass;
  ...
  public Serializable getIdentifier() {
    return Databinder.getHibernateSession().getIdentifier(getObject());
  }
  ...
  public void checkBinding() {
    if (!isBound() && retainedObject != null) {
      final Session sess = Databinder.getHibernateSession(factoryKey);
