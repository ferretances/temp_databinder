...
/**
 * <h1>PredicateSorter</h1> <i>Copyright (C) 2008 The Scripps Research
 * Institute</i>
 * <p>
 * A Predicate based sorter suitable for adding to a JPAProvider
 * </p>
 * *
 * 
 * <pre>
 * // a default sort by name, ascending and case insensitive:
 * PredicateSorter sorter = new PredicateSorter(&quot;name&quot;, true, false);
 ...
 * @deprecated Use a subclass or OrderingPredicateBuilder instead. It avoids
 *             problems with duplicate Aliases.
 */
@Deprecated
public class PredicateSorter<T> implements ISortStateLocator,
PredicateBuilder<T> {
  ...
  public PredicateSorter(final Class<T> entityClass) {
  ...
  public PredicateSorter(final String defaultProperty, final boolean asc,
      final Class<T> entityClass) {
