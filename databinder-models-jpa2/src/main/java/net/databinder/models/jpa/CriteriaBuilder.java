...
/**
 * Interface for callback that sets parameters for a Hibernate Creteria object
 * and any necessary sub-criteria.
 * @author Nathan Hamblen
 */
public interface CriteriaBuilder<T> extends Serializable {
  /** Add properties, set projections, etc. */
  void build(javax.persistence.criteria.CriteriaBuilder criteria);
}
