...
public abstract class ExceptionFilteringRequestCycle extends WebRequestCycle {
   ...
   * @param response
   */
  public ExceptionFilteringRequestCycle(final WebApplication application,
   ...
   * exception thrown by a class (found by stack trace) matching this pattern is
   * logged as a warning. Set this to null to disable filtering and log all
   * exceptions in super.
   * @param pattern to match against fully qualified class name of exception
   *          origin
   */
