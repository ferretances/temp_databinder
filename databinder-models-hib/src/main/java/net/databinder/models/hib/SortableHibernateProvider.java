...
public class SortableHibernateProvider<T> extends HibernateProvider<T> implements ISortableDataProvider<T> {
	...
	public SortableHibernateProvider(final Class<T> objectClass, final CriteriaBuilder criteriaBuilder, final CriteriaBuilder orderingCriteriaBuilder) {
    ...
    public SortableHibernateProvider(final Class<T> objectClass, final OrderingCriteriaBuilder criteriaBuilder) {
    ...
    public void setSortState(final ISortState state) {
        if (sortStateLocator != null) {
           //TODO sortStateLocator.setSortState(state);
        }
        else {
