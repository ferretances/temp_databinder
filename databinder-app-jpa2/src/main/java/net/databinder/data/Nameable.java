...
public class Nameable {
  ...
  /**
   * Converts string to lowercase with spaces as hyphens and other non-word
   * charters removed.
   * @return string in all lowercase with no whitespace or other non-word
   *         characters
   */
  public static String stringIdFor(final String string) {
    if (string == null) {
      return null;
    }
    return nonWords.matcher(
        spaces.matcher(string.toLowerCase()).replaceAll("-")).replaceAll("");
  }
}
