...
implements IUnauthorizedComponentInstantiationListener, org.apache.wicket.authroles.authorization.strategies.role.IRoleCheckingStrategy, AuthApplication {
   ...
   */
  @Override
  public Session newSession(final org.apache.wicket.request.Request request, final org.apache.wicket.request.Response response) {
