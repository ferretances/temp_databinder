...
public class DataPanel<T> extends Panel {
   ...
   */
  public DataPanel(final String id, final JPAObjectModel<T> model) {
   ...
   */
  public DataPanel(final String id, final Class<T> modelClass, final Serializable persistentObjectId) {
    super(id, new CompoundPropertyModel<T>(new JPAObjectModel<T>(modelClass, persistentObjectId)));
  }
   ...
   */
  protected DataPanel(final String id) {
    super(id);
  }
  ...
  protected JPAObjectModel<T> getPersistentObjectModel() {
    try {
   ...
   */
  public DataPanel<T> setPersistentObject(final T object) {
   ...
   * @return this panel, for chaining
   */
  protected DataPanel<T> setPersistentObjectModel(final JPAObjectModel<T> model) {
