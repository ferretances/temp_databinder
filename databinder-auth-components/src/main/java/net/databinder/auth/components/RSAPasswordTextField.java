...
public class RSAPasswordTextField extends PasswordTextField implements IHeaderContributor {
  ...
  public RSAPasswordTextField(final String id, final IModel<String> model, final Form form) {
    super(id, model);
    init(form);
  }
  @Override
  ...
  @Override
  protected String convertValue(final String[] value) throws ConversionException {
